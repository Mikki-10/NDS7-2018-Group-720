...
class TX
{
	...
	function make_page($tx_hash)
	{
		...
		<tbody>
			...
			<tr><td>fee</td><td><?php echo $tx_data["gas"] . "*" . floatval(hexdec($tx_data["gasPrice"])/1000000000000000000) . "=" . number_format($tx_data["gas"]*(floatval(hexdec($tx_data["gasPrice"])/1000000000000000000)), 18, ",", "."); ?></td></tr>
